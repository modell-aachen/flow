defmodule Ariadne.Flow.Examples.DynamicProductPrice.Events do
  ...
  defmodule ProductDefined do
    @derive {Ariadne.Flow.Store.Event.Encoder, type: "product-defined"}
  ...
  defmodule ProductPriceChanged do
    @derive {Ariadne.Flow.Store.Event.Encoder, type: "product-price-changed"}
  ...
  defmodule ProductsOrdered do
    @derive {Ariadne.Flow.Store.Event.Encoder, type: "products-ordered"}
    defstruct [:items]
